...
class _UpdateUserState extends State<UpdateUser> {
  ...
  void initState() {
    ...
    widget.user.role == 'STUDENT'
        ? assignValuesStudent()
        : assignValuesFaculty();
    _fetchClasses(widget.user.departmentName.toString());
  }

  void assignValuesStudent(){
    nameController.text = widget.user.name.toString();
    emailController.text = widget.user.email.toString();
    contactController.text = widget.user.contact.toString();
    enrollmentController.text = widget.user.enrollment_no.toString();
    dropdownValue = widget.user.departmentName.toString();
    classValue = widget.user.className.toString();
    rolesValue = widget.user.role.toString();
  }
  void assignValuesFaculty(){
    nameController.text = widget.user.name.toString();
    emailController.text = widget.user.email.toString();
    contactController.text = widget.user.contact.toString();
    dropdownValue = widget.user.departmentName.toString();
