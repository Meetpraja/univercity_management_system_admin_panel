...
import 'package:ksv_student_management/components/teacher_list.dart';
import '../../model/department/department_model.dart';
import '../../model/users/users_model.dart';
import '../../services/database_services.dart';
import '../student/update_user.dart';
...
class _TeacherState extends State<Teacher> {
  ...
  Future<void> _fetchUsers() async {
    try {
      ...
      final fetchedUser = await Services().fetchUsers('FACULTY');
      users = fetchedUser;
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(e.toString())));
    } finally {
    ...
    return Column(
      ...
      children: [
        ...
        isFetchingUser
            ...
            : TeacherList(users: filteredUsers,onDelete: _deleteUser, onUpdateUser: onUpdateUser,),
